...
$checks = array(
    ...
    array( strpos( $functions_source, 'stapleit_cora_planner_explain' ) === false, 'obsolete planner explanation AJAX endpoint stays removed' ),
    array( strpos( $functions_source, 'stapleit_cora_package_plan' ) === false && strpos( $functions_source, 'stapleit_cora_pack_plan' ) === false, 'obsolete server-side questionnaire planning functions stay removed' ),
    array( strpos( $functions_source, "'pack_finder_started', 'pack_finder_completed'" ) !== false && strpos( $functions_source, 'package_finder_started' ) === false, 'planner analytics retain only live add-on finder events' ),
