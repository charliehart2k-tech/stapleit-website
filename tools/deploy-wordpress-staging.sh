...
grep -Fq '<strong>POA</strong>' "$THEME/static-it-support.php"
...
grep -Fq "wp_ajax_nopriv_stapleit_support_adviser" "$THEME/functions.php"
...
grep -Fq 'data-support-adviser' "$THEME/static-it-support.php"
